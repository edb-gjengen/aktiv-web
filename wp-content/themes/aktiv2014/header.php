...
<head>
    ...
    <link href="<?php bloginfo( 'stylesheet_directory' ); ?>/app/styles/main.css" rel="stylesheet" type="text/css" />
    ...
    <?php wp_head(); ?>
    <script src="<?php bloginfo( 'stylesheet_directory' ); ?>/app/scripts/main.js"></script>
